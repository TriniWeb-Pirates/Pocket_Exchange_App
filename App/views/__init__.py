...
from .profilepage import profilepage_views
...
views = [user_views, index_views, trend_views, leaderboard_views, profilepage_views, myitems_views, lendingOffer_views,lendingRequests_views]